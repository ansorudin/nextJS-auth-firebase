...
const TranckingId = '211007281'
const TranckingContext = React.createContext()
...
const TrackerProvider = (props) => {
    ...
    return <TranckingContext.Provider {...props} />
}

const useTracking = () => React.useContext(TranckingContext);

export { TrackerProvider, useTracking }
